      ...
      <div className="px-6 bg-[#e3f2fd]">
        <Waypoints target={"tocontact"}>
          <section id="contact" className="pt-28">
            ...
            <div className="max-w-screen-xl sm:px-8 grid gap-4 xl:gap-8 grid-cols-1 lg:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto text-gray-900">
                ...
                <div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-5 mt-1">
                      <li>
                        <a
                          href="mailto:usamabinnadeem10@gmail.com"
                          className="hover:text-indigo-500"
                        >
                          <FaEnvelope className="fill-indigo-500 inline-block" />{" "}
                          usamabinnadeem10@gmail.com
                        </a>{" "}
                      </li>
                      <li>
                        <a
                          href="tel:+923120798798"
                          className="hover:text-indigo-500"
                        >
                          <FaPhone className="fill-indigo-500 inline-block" />{" "}
                          +923120798798
                        </a>{" "}
                      </li>
                    </ul>
              ...
              <div>
                ...
                <iframe
                  src="https://docs.google.com/forms/d/e/1FAIpQLSfXZYK2hbdeP6cDXvoZ6v3RelQbnFYhXGxfxEY1SlXTc8CYkg/viewform?embedded=true"
                  // width="640"
                  // height="800"
                  frameborder="0"
                  marginheight="0"
                  marginwidth="0"
                  className="w-[280px] xxs:w-[350px] xs:w-[440px] sm:w-[500px] h-[800px] lg:w-[500px] xl:w-[600px] mx-auto"
                >
                  Loading…
                </iframe>
              </div>
